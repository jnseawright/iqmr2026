...
include_graphics("img/liebermanarticle1.png")
```

---

```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/liebermanbook1.png")
```

---

```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/liebermanbook2.png")
```

---

```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/liebermanbook3.png")
```
...
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/galvin1.jpg")
```

---

```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/galvin2.jpg")
```
...
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/galvin4.jpg")
```

---

```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/galvin5.jpg")
```
...
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/galvin6.jpg")
```
...
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/galvin7.jpg")
```
...
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/galvin8.jpg")
```

---

```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/galvin9.jpg")
```

---

```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/galvin10.jpg")
```

---

```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/galvin11.jpg")
```

---

```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/galvin12.jpg")
```
...
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/colombiamountains.jpg")
```
...
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/laviolencia.jpg")
```
...
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/colombiafarc.jpg")
```
...
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/columbia_farc_02.jpg")
```
...
```{r, echo = FALSE, out.width="50%", fig.retina = 1, fig.align='center'}
include_graphics("img/bogota.jpg")
```
