...
**Example:** Snow on Cholera (variation in water source).
...
- **Natural Experiment:** Draft lottery randomly assigned priority numbers to specific birthdates.
- **Treatment:** Draft eligibility (proxy for military service).
...
**Qualitative challenge:** Are there cases where settler mortality affected GDP through causal pathways other than institutions? Can we find evidence?
...
- We still won't fully test mediation theories; the assumptions for such a test are severe.
...
# Load data
library(foreign)
final4 <- read.dta("https://raw.githubusercontent.com/jnseawright/iqmr2026/main/Data/final4.dta")
final5 <- read.dta("https://raw.githubusercontent.com/jnseawright/iqmr2026/main/Data/final5.dta")
